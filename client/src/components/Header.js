...
function Header() {
  ...
  return (
    <header className="z-40 py-4 bg-white shadow-bottom dark:bg-gray-800">
      <div className="container flex lg:justify-end justify-between h-full px-6 mx-auto text-green-600 dark:text-gray-200">
        {/* <!-- Mobile hamburger --> */}
        <button
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          ...
          <li className="relative">
            <button
              className="rounded-full capitalize h-6 w-6 p-5 flex items-center justify-center font-bold bg-gray-300 dark:text-green-600 focus:shadow-outline-purple focus:outline-none"

  ...
  return (
    <>
      <div>
        ...
        {title === "Basic" && (
          ...
          {title === "Medium" && (
            <div className="z-50 flex w-full items-center justify-end">
              <span
                className="py-1 rounded-sm bg-green-600 text-center text-gray-100 text-xs w-full"
                type="success"
              >
                Bestseller
              </span>
        ...
        <div className="z-50 flex w-full items-center justify-end">
              <span className="py-1 rounded-sm bg-green-600 text-center text-gray-100 text-xs w-full" type="success">
                Bestseller
              </span>
            </div>
            <CardBody>

                  ...
                  <div>
                    <div className="text-gray-600 dark:text-gray-400 pt-4">
                      ...
                      <p>
                        {" "}
                        {t(
                          "Just click on the green button to view, edit or add new images to your current listings."
                        )}{" "}
                      </p>
                    ...
                    <div className="md:flex block gap-8">
                      <div className="text-gray-600 dark:text-gray-400 pt-4">
                        <div>
                          ...
                          {t(
                            "You have not created any listings yet. Click on the green button and create your first listing."
                          )}{" "}
                        </div>
